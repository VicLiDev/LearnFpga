...
compile() {
    ...
    # 01_tb_basic.v: 依赖 ripple_carry_adder_4bit + full_adder
    ...
    # 02_tb_self_checking.v: 依赖 ripple_carry_adder_4bit + full_adder
    ...
    # 03_tb_coverage.v: 依赖 sequence_detector
